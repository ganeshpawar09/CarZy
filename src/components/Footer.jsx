...
export default function Footer() {
  return (
    <footer className="font-monda mt-auto py-12 px-6 bg-white border-t border-gray-300 text-center">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Company Info */}
          <div className="flex flex-col items-center">
            <h3 className="font-bold text-lg mb-4">CarZy</h3>
            <p className="font-monda text-gray-600 mb-4">
              Car rental service for all your travel needs.
            </p>
          ...
          <div className="flex flex-col items-center">
            ...
            <ul className="space-y-2 text-gray-600">
              ...
              <li>
                <a href="#why-choose-us" className="hover:text-black">
                  Why Choose Us
                </a>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-300 text-center text-gray-600">
          <p>&copy; {new Date().getFullYear()} CarZy. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
